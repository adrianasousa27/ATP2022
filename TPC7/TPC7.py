...
def tabela3():
    ...
    print(f"{'':20}|{'ENGBIOM':^20}|{'ENGFIS':^20}|{'LEI':^20}|{'LCC':^20}|")
    print(f"{'':_^105}")
    print(f"|{'Alunos:':^19}|{list(alunos_curso(ler()).values())[0]:^20}|{list(alunos_curso(ler()).values())[1]:^20}|{list(alunos_curso(ler()).values())[2]:^20}|{list(alunos_curso(ler()).values())[3]:^20}|")
    print(f"{'':_^105}")
