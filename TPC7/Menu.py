...
while i != 0:
    ...
    if i == 1:
        ...
        tpc.adicionar_coluna(tpc.listacomp(tpc.paralistag(tpc.grau(alunos))))
        ...
        "0 - Sair")
            ...
            if l == 1:
                print(tpc.distribuicaoP(tpc.alunos_curso(tpc.ler()), "Distribuição dos alunos por curso", "Curso", "Número de alunos"))
            if l == 2:
        ...
        "0 - Sair")
            ...
            if p == 1:
                print(tpc.graf(tpc.alunos_curso(tpc.ler()), "Distribuição dos alunos por curso", "Curso", "Número de alunos"))
            if p == 2:
